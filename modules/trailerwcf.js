				...
				for(var i = 0; i < str1.length; i++) {
					...
					if(i < str1.length) {
						trailerDetail(str3.BILLID, i, function(result) {
							if(arraystr[flag]) {
								var str4 = {
									BILLID: arraystr[flag].BILLID,
									BILLNO: arraystr[flag].BILLNO,
									BILLCODE: arraystr[flag].BILLCODE,
									CONTAINERNO: arraystr[flag].CONTAINERNO,
									SIZE: arraystr[flag].SIZE,
									TYPE: arraystr[flag].TYPE,
									TRUCKNO: arraystr[flag].TRUCKNO,
									DRIVER: arraystr[flag].DRIVER,
									TELEPHONE: arraystr[flag].TELEPHONE,
									DETAIL: result
								};
								array.push(str4);
							}

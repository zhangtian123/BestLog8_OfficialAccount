    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	...
    	xmlParser.parseString(response, function (err, result) {
			...
			for(var i=0;i<str1.length;i++)
			{
				...
				var str4 = {ORDERID:str1[i].BILLID,ORDERNO:str1[i].ORDERNO,CUSTOMSCOMPANY:str1[i].REQUESTER,CUSTOMSOP:str1[i].REFNO,SONO:str1[i].BOOKINGNO,HBLNO:str1[i].HBLNO,CNTRNUMSTR:str1[i].CNTRNUMSTR};
				//console.log(str4);
				array.push(str4);
			}
			callback(array);
...
exports.ShippingOrderList = function(predicate, values, pageNum, pageSize, orderByProperty,userCode, rowsCount, callback){
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	...
    	xmlParser.parseString(response, function (err, result) {
			...
			{
				//获取订单
				var str4 = {BILLID:str1[i].BILLID,BILLNO:str1[i].BILLNO,REFNO:str1[i].REFNO,CARGONAME:str1[i].CARGONAME,CNTRNUMSTR:str1[i].CntrNumStr,CTNS:str1[i].CTNS,PACK:str1[i].PACK,WEIGHT:str1[i].WEIGHT,MEASURE:str1[i].MEASURE,SHIPOWNER:str1[i].SEA_SHIPOWNER,SEA_SAILLINE:str1[i].SEA_SAILLINE,SEA_VESSEL:str1[i].SEA_VESSEL,SEA_VOYNO:str1[i].SEA_VOYNO};
				//console.log(str4);
				array.push(str4);
			}
			callback(array);
...
exports.getBaseCodes = function(predicate, values, iCounts, callback){
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	xmlParser.parseString(response, function (err, result) {
			...
			{
				var str3 = str1[i];
				var str4 = {text:str3.CODEATTRNAME,value:str3.CODEATTRNAME};
				array.push(str4);
			}
			callback(array);
		});
...
exports.getSailLines = function(predicate, values, iCounts, callback){
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	xmlParser.parseString(response, function (err, result) {
			...
			{
				var str3 = str1[i];
				var str4 = {text:str3.LINECNNAME,value:str3.SAILCODE};
				array.push(str4);
			}
			callback(array);
		});
...
exports.getShips = function(predicate, values, iCounts, callback){
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	xmlParser.parseString(response, function (err, result) {
			...
			{
				var str3 = str1[i];
				var str4 = {text:str3.NAMEEN,value:str3.SHIPCODE};
				array.push(str4);
			}
			callback(array);
		});
...
exports.getRoleUsers = function(billcode, rolecode, callback){
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	xmlParser.parseString(response, function (err, result) {
			...
			{
				var str3 = str1[i];
				var str4 = {text:str3.USERNAME+"|"+str3.USERCODE,value:str3.USERCODE};
				array.push(str4);
			}
			callback(array);
		});
...
exports.getCustomers = function(predicate, values, iCounts, callback){
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	xmlParser.parseString(response, function (err, result) {
			...
			{
				var str3 = str1[i];
				var str4 = {text:str3.SHORTNAME,value:str3.SHORTNAME};
				array.push(str4);
			}
			callback(array);
		});

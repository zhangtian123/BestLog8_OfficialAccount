    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	xmlParser.parseString(response, function (err, result) {
			...
			for(var i=0;i<str1.length;i++)
			{
				...
				var str4 = {NAMECH:str3.NAMECH,NAMEEN:str3.NAMEEN};
				//console.log(str4);
				array.push(str4);
			}
			callback(array);
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	xmlParser.parseString(response, function (err, result) {
			...
			for(var i=0;i<str1.length;i++)
			{
				...
				//console.log(str4);
				var str4 = {text:str3.TYPENAMECH,value:str3.TYPENAMEEN};
				array.push(str4);
			}
			callback(array);
		});
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	...
    	xmlParser.parseString(response, function (err, result) {
			...
			if(str1.length!=0)
			{
				...
				{
					var str3 = str1[i];//.OriginalValues;
					var str4 = {BILLID:str3.BILLID,BILLNO:str3.BILLNO,CUSTOMER:str3.CARRIER,
						SAILINGDATE:str3.SAILINGDATE,DAYNUM:str3.DAYNUM,PORTLOADING:str3.PORTLOADING,
						PORTDISCHARGE:str3.PORTDISCHARGE,ISDIRECT:str3.ISDIRECT,BASEPORT:str3.BASEPORT,
						STARTDATE:str3.STARTDATE,ENDDATE:str3.ENDDATE,PRICE20GP:str3.BossPrice20GP,
						PRICE40GP:str3.BossPrice40GP,PRICE40HQ:str3.BossPrice40HQ,TotalPrice:str3.TotalPrice};
					//console.log(str4);
					array.push(str4);
				}
			}
    ...
    Basic.BasicConnect(addstring, messagestring,function(response){
    	...
    	xmlParser.parseString(response, function (err, result) {
			...
			if(str1.length!=0)
			{
				...
				{
					var str3 = str1[i];//.OriginalValues;
					var str4 = {CUSTOMER:str3.Customer,BEGINDATE:str3.BeginDate,ENDDATE:str3.EndDate,
						CARRIER:str3.CARRIER,PORTLOADING:str3.PORTLOADING,PORTDISCHARGE:str3.PORTDISCHARGE,
						PRICE20GP:str3.PRICE20GP,PRICE40GP:str3.PRICE40GP,PRICE40HQ:str3.PRICE40HQ,
						QUANTITY20GP:str3.QUANTITY20GP,QUANTITY40GP:str3.QUANTITY40GP,QUANTITY40HQ:str3.QUANTITY40HQ,
					ISDIRECT:str3.ISDIRECT,DAYNUM:str3.DAYNUM,ETD:str3.ETD};
					//console.log(str4);
					array.push(str4);
				}
			}

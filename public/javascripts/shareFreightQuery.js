				...
				success:function(data){
					...
					for(var o in data)
					{
						...
						$.each(result,function(key,value){
							...
							Inner(index,value.BILLID,value.PORTLOADING,transtype,value.PORTDISCHARGE,value.BASEPORT,value.CUSTOMER,value.SAILINGDATE,value.DAYNUM,value.STARTDATE,value.ENDDATE,value.PRICE20GP,value.PRICE40GP,value.PRICE40HQ,oDiv);

...
var Inner = function(index, begin, line, end, port, company, time, sail, expirydatebegin, expirydateend, GPprice20, GPprice40, HCprice40, GPquantity20, GPquantity40, HCquantity40, Customer, oDiv) {
	...
	var total =  computeFee(GPprice20, GPprice40, HCprice40, GPquantity20, GPquantity40, HCquantity40) ;
	oDiv.innerHTML = oDiv.innerHTML +
		'<div class="item">' +
		...
		'<span style="margin-left:8px;color:#0078cd;">运费：'+total.totalFeeValue+'</span>' +
		'<span style="margin-left:8px;">' +total.totalFee+ '</span>' +
		'</div>' +
		'</div>';
}
